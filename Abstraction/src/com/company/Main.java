...
* Abstract Classes behave almost similar to Interfaces, where you define the name, return type and parameter names
* and their types, however as it's a class - you can also define constructors, fields and other public/ private
* methods within the class, which compared to Interfaces where couldn't do any of those, as their variables will be
* public static final - meaning they are constants
* As a side note, abstract classes cannot be instantiated - it seems best to inherit from abstract classes - as to
* say build a generic class and inherit into more unique subclasses
*
* To define an abstract class
* public abstract class ClassName {...}
*
* This tells Java we want this class to be abstract, and within abstract classes, you can define abstract methods -
* this is where you outline the method signature
* 	public abstract void eat();
*	public abstract void breathe();
*
* And any classes that inherit from an abstract class, must define these abstract methods
* */
